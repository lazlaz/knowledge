...
public class MyURLClassLoader extends SecureClassLoader implements Closeable {
    ...
    MyURLClassLoader(URL[] urls, ClassLoader parent,
    ...
    MyURLClassLoader(URL[] urls, AccessControlContext acc) {
        super();
        // this is to make the stack depth consistent with 1.1
        SecurityManager security = System.getSecurityManager();
        if (security != null) {
    ...
    */
     ...
     */
    public static MyURLClassLoader newInstance(final URL[] urls,
                                             final ClassLoader parent) {
        // Save the caller's context
        final AccessControlContext acc = AccessController.getContext();
        // Need a privileged block to create the class loader
        MyURLClassLoader ucl = AccessController.doPrivileged(
            new PrivilegedAction<MyURLClassLoader>() {
                public MyURLClassLoader run() {
...
final class FactoryURLClassLoader extends MyURLClassLoader {
